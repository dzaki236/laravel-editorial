        ...
        <div class="container">
            <div class="flipbook">
                ...
                <div class="bg-white p-4">
                    ...
                    <div class="row"
                        style="font-family: Arial, Helvetica, sans-serif; font-size:14px; color:rgb(34, 17, 0);">
                                <div class="col m-1"><p class=""><span class="h2">T</span>enaga medis merupakan aset negara. Bila nyawa tenaga medis terus berkurang, maka penanganan pandemi akan semakin sulit. Terlepas dari angka-angka, setiap nyawa yang hilang tidak dapat tergantikan oleh keluarga yang ditinggalkan.
                                </p>
                        </div>
                        <div class="col m-2"><p><span class="h2">J</span>umlah kematian tenaga medis yang terus meningkat, indikasi bahwa pemerintah dan masyarakat kurang berempati pada perjuangan mereka. Bila kebijakan tidak dibenahi, serta kepatuhan masyarakat terus menurun, berapa banyak lagi tenaga medis yang harus gugur.</p></div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-12 m-2"><h1 class="text-center" style="font-family: 'Times New Roman', Times, serif"><b>Huru-hara Vaksin Covid-19</b></h1>
                                    <div style="font-family: Arial, Helvetica, sans-serif; font-size:14px; color:rgb(34, 17, 0);">
                                    <p><span class="h2">S</span>atuan Tugas (Satgas) Penanganan Covid-19, pemerintah, dan peneliti seharusnya berkoordinasi dengan baik dalam menyampaikan informasi ke publik. Petengahan tahun lalu kita sempat mendengar bahwa pemerintah menjanjikan vaksin pada November 2020. Sementara penelitian dan percobaan vaksin masih terus berjalan, dan belum dapat dipastikan pengaplikasiannya ke manusia. Publik diombang-ambingkan.</p>
                                    <p>Organisasi Kesehatan Dunia (WHO) sampai saat ini belum menganjurkan pemberian vaksin karena memang penelitian terhadap vaksin belum juga usai. Hal tersebut dibenarkan oleh juru bicara Satuan Tugas Penanganan Covid-19, Iku Adisasmito. Ia meminta masyarakat untuk sabar menanti vaksin Covid-19.</p>
                                    <p>Pemerintah mungkin bermaksud baik, menyampaikan janji soal vaksin agar masyarakat tidak panik. Namun penyampaian informasi atau janji ke publik tetap harus berdasarkan fakta di lapangan. Ketidakselarasan antara ujaran pemerintah dengan satgas dan para peneliti, mengindikasikan kurangnya koordinasi dan komunikasi.</p>                                    
                        </div>
            </div>
                    </div>
                </div>
                <div class="bg-white"><img src="http://www.umm.ac.id/files/image/slip086.jpg" width="800em" alt=""><img src="https://kambinglaut.files.wordpress.com/2008/03/koran.jpg" class="w-50" alt=""></div>
                <div
